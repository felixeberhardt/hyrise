...
struct BenchmarkItemRunResult {
  BenchmarkItemRunResult(Duration init_begin, Duration init_duration, std::unordered_map<std::string, double> perf_counter,
  ...
  std::unordered_map<std::string, double> perf_counter;
